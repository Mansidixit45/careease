  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white pt-16 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <a
              href="/register"
              className="px-8 py-3 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-colors shadow-lg text-sm"
            >
              🚀 Get Started Free
            </a>
            <a
              href="/login"
              className="px-8 py-3 border-2 border-white text-white font-bold rounded-xl hover:bg-white hover:text-blue-600 transition-colors text-sm"
            >
              Login
            </a>
          </div>
      ...
      <div className="bg-blue-600 py-16 px-6 text-center text-white">
        ...
        <a
          href="/register"
          className="inline-block px-10 py-3 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-colors shadow-lg"
        >
          🚀 Free Account Banao
        </a>
      </div>
